...
fn main() {
    ...
    println!("Overhead per item: {:.2} ns", bplus_per_item - btree_per_item);
    ...
    for &capacity in &[4, 8, 16, 32, 64, 128] {
        ...
        let ratio = cap_time.as_nanos() as f64 / (btree_time.as_nanos() as f64 / iterations as f64 * test_iterations as f64);
    ...
    println!("  Ratio: {:.2}x", bplus_partial.as_nanos() as f64 / btree_partial.as_nanos() as f64);
}
