...
fn main() {
    ...
    println!();
    println!(
        "First element access ({} times): {:?}",
        iterations, first_access_time
    );
    println!(
        "Per first access: {:.2} ns",
        first_access_time.as_nanos() as f64 / iterations as f64
    );
    ...
    println!();
    println!(
        "Same-leaf sequential access ({} * 15): {:?}",
        test_iterations, same_leaf_time
    );
    println!(
        "Per same-leaf access: {:.2} ns",
        same_leaf_time.as_nanos() as f64 / (test_iterations * 15) as f64
    );
    ...
    println!();
    println!(
        "Cross-leaf access ({} times): {:?}",
        test_iterations, cross_leaf_time
    );
    println!(
        "Per cross-leaf access: {:.2} ns",
        cross_leaf_time.as_nanos() as f64 / test_iterations as f64
    );
    ...
    println!();
    println!(
        "Arena access simulation ({} times): {:?}",
        lookup_iterations, arena_simulation_time
    );
    println!(
        "Per simulation: {:.2} ns",
        arena_simulation_time.as_nanos() as f64 / lookup_iterations as f64
    );
    ...
    println!(
        "BPlusTree iteration (1000 * {} items): {:?}",
        size, bplus_full_time
    );
    println!(
        "BPlusTree per item: {:.2} ns",
        bplus_full_time.as_nanos() as f64 / (1000 * size) as f64
    );
