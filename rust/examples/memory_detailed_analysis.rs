...
fn main() {
    ...
    for &size in &[10, 100, 1000, 10000] {
        ...
        println!(
            "    Per element: {:.1} bytes",
            btree_total as f64 / size as f64
        );
        ...
        println!(
            "    Per element: {:.1} bytes",
            bplus_total as f64 / size as f64
        );
    ...
    for &capacity in &[4, 16, 64, 128, 256] {
        ...
        println!(
            "Capacity {}: {} total bytes ({:.1} per element)",
            capacity,
            total,
            total as f64 / dataset_size as f64
        );
    }
