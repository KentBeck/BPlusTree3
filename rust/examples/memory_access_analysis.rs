...
fn main() {
    ...
    println!(
        "Ratio: {:.2}x",
        bplus_sequential.as_nanos() as f64 / btree_sequential.as_nanos() as f64
    );
    ...
    println!(
        "Ratio: {:.2}x",
        bplus_random.as_nanos() as f64 / btree_random.as_nanos() as f64
    );
    ...
    println!(
        "  Ratio: {:.2}x",
        bplus_small_range.as_nanos() as f64 / btree_small_range.as_nanos() as f64
    );
    ...
    println!(
        "  Ratio: {:.2}x",
        bplus_large_range.as_nanos() as f64 / btree_large_range.as_nanos() as f64
    );
    ...
    println!(
        "  BTreeMap: {:?} ({:.2} ns each)",
        btree_iter_creation,
        btree_iter_creation.as_nanos() as f64 / 100000.0
    );
    println!(
        "  BPlusTreeMap: {:?} ({:.2} ns each)",
        bplus_iter_creation,
        bplus_iter_creation.as_nanos() as f64 / 100000.0
    );
    ...
    println!(
        "  BTreeMap: {:?} ({:.2} ns each)",
        btree_first_access,
        btree_first_access.as_nanos() as f64 / 100000.0
    );
    println!(
        "  BPlusTreeMap: {:?} ({:.2} ns each)",
        bplus_first_access,
        bplus_first_access.as_nanos() as f64 / 100000.0
    );
